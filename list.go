...
func createMimeToExt() map[string][]string {
	mimeToExt := map[string][]string {
		 ...
		 "text/x-c": {"cc", "cpp", "c", "cxx", "dic", "hh", "h"},
		 ...
		 "image/x-freehand": {"fh4", "fh5", "fh7", "fhc", "fh"},
		 ...
		 "audio/mpeg": {"m2a", "m3a", "mp2a", "mp2", "mp3", "mpga"},
		 ...
		 "text/troff": {"man", "me", "ms", "roff", "tr", "t"},
		 ...
		 "application/xv+xml": {"xhvml", "xvm", "mxml"},
		 ...
		 "application/onenote": {"onepkg", "onetmp", "onetoc2", "onetoc"},
